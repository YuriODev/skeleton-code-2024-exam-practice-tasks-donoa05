...
class Pattern():
  ...
  def OutPutPatternCount(self):
    print(f"{self.__Symbol} pattern can be placed {self.PatternCount} times")
  #==========================================================================
