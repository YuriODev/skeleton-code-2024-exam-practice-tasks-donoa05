  ...
  def SavePuzzle(self):
    try:
      ...
      with open(Filename+".txt", "w") as f:
        ...
        for P in self.__AllowedPatterns:
          f.write(P.GetPatternName() + "," + P.GetPattern() + "\n")
        f.write(str(self.__GridSize) + "\n")
        for Count in range(0, len(self.__Grid)):
          if self.__Grid[Count].GetSymbol() == "-":
            f.write("@" + "," + self.__Grid[Count].GetNotAllowedSymbols() +
                    "\n")
          else:
            f.write(self.__Grid[Count].GetSymbol() + "," +
                    self.__Grid[Count].GetNotAllowedSymbols() + "\n")
